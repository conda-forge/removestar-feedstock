...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/removestar-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7365&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/removestar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `removestar` can be installed with:

```
conda install removestar
```

It is possible to list all of the versions of `removestar` available on your platform with:
